...
$$willReoffend = \lfloor `r coeffs[1]` + `r coeffs[2]` \cdot age +$$
$$`r coeffs[3]` \cdot logPriorsCount + `r coeffs[4]` \cdot riskRecidDecileScore \rceil$$
...
This is our third model. This model is a multiple regression model attempting to achieve parity with the algorithm which was used to calculate `riskRecidDecileScore`. The following plots are some data visualization.
